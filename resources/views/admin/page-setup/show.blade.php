        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <hr/>
                    <p><span class="text-highlight">{{ __('dashboard.meta_title') }}:</span> {{ $row->meta_title }}</p>
                    <p><span class="text-highlight">{{ __('dashboard.meta_description') }}:</span> {!! $row->meta_description !!}</p>
                    <p><span class="text-highlight">{{ __('dashboard.meta_keywords') }}:</span> {!! $row->meta_keywords !!}</p>
